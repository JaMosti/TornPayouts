...
# --- Edit
enemy_faction = 8766
war_from = "15:00:17 25/10/25"
war_to = "19:22:05 30/10/25"
key = ""        # https://www.torn.com/preferences.php#tab=api
cf_factor = 1           # Price for crossfire hit
            ...
            for attack in attacks:
                ...
                if respect_gain:
                    if attack["defender"]["faction_id"] == enemy_faction:
                        ...
                        output_data[attack["attacker"]["id"]]["respect_war"] += respect_gain
...
for member in output_data:
    output_data[member]["adjusted_respect"] = output_data[member]["respect_war"] + output_data[member]["respect_crossfire"] * cf_factor
